...
window.MOSQUE_CONFIG = {
    ...
    MOSQUE_ID:     'tn.monastir.ghofran',

    // ── Identité de la mosquée ────────────────────────────────────────────────
    MOSQUE_NAME:   'جامع الغفران ببنّان',           // Nom affiché dans l'application
    ...
    QR_URL:        'https://drive.google.com/open?id=1USB30mAUHYVT8EkWOHUOYGE0L2uEyDBF',  // URL encodée dans le QR
    //QR_URL_64:      'https://drive.google.com/open?id=1tMo0KX-5dWxiYo1cg8kpreVeudfpIuGi',  // URL64 encodée dans le QR
