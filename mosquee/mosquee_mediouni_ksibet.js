...
window.MOSQUE_CONFIG = {
    ...
    VERSION:       '1.3',                    // ← incrémenter à chaque modification
    MOSQUE_ID:     'tn.monastir.mediouni',

    // ── Identité de la mosquée ────────────────────────────────────────────────
    MOSQUE_NAME:   'جامع المديوني بقصيبة المديوني',           // Nom affiché dans l'application
    ...
    JUMUA_TIME:    '15:00',                  // 'AUTO' ou heure fixe ex: '13:15'
    ...
    QR_URL:        'https://drive.google.com/open?id=1su-hh2Oe7K7wU0u4wJsviDt1Q_SfJPZ7',  // URL32 encodée dans le QR
    //QR_URL_64:      'https://drive.google.com/open?id=1HELBeqR3fszeEu8mrLHQUPn1wy8lA74U',  // URL64 encodée dans le QR
