...
window.MOSQUE_CONFIG = {
    ...
    VERSION:       '1.4',                    // ← incrémenter à chaque modification
    MOSQUE_ID:     'tn.monastir.nadour',

    // ── Identité de la mosquée ────────────────────────────────────────────────
    MOSQUE_NAME:   'جامع النّور بقصيبة المديوني',           // Nom affiché dans l'application
    ...
    JUMUA_TIME:    '12:30',                  // 'AUTO' ou heure fixe ex: '13:15'
    // ── QR Code ───────────────────────────────────────────────────────────────
    ...
    QR_URL:        'https://drive.google.com/open?id=1FDEFy9i0TcPjDaVkQwKQmH8TBaFZu_cj',  // URL32 encodée dans le QR
    //QR_URL_64:      'https://drive.google.com/open?id=1iyNtPC7KHEQKykdneXfLFa-EpfmY3nra',  // URL64 encodée dans le QR
