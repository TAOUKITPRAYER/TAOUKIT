...
window.MOSQUE_CONFIG = {
    ...
    VERSION:       '1.5',                    // ← incrémenter à chaque modification
    MOSQUE_ID:     'tn.monastir.youssef',

    // ── Identité de la mosquée ────────────────────────────────────────────────
    MOSQUE_NAME:   'مسجد يوسف',           // Nom affiché dans l'application
    ...
    IQAMA_DELAYS: {
        FAJR:    25,                         // minutes après l'azan
        DHUHR:   30,
        ASR:     8,
        MAGHREB:  8,                         // MAGHREB n'a pas d'heure fixe
        ISHA:    10,
    },
    ...
    // ── Jumu'ah ───────────────────────────────────────────────────────────────
    JUMUA_ENABLED: 0,                       // 0 = non affiché, 1 = affiché
    JUMUA_TIME:    'AUTO',                  // 'AUTO' ou heure fixe ex: '13:15'
    // ── QR Code ───────────────────────────────────────────────────────────────
    ...
    QR_URL:        'https://drive.google.com/open?id=1rRStjzjC5tjpkMi0XBLVjuqfHVNh0AAA',  // URL32 encodée dans le QR
    //QR_URL_64:      'https://drive.google.com/open?id=1P408fv2GXztj52uRf69N9wnFtm2R3GLV',  // URL64 encodée dans le QR
    ...
    DISPLAY_OPTIONS: {
        ...
        NO_MOBILE_REMINDER:     1,   // rappel de fermer le téléphone
